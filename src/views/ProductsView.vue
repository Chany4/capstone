    ...
    <div>
      ...
      <div class="container">
        ...
        <div v-else>
          ...
          <div class="row">
            <div class="col-md-3 mb-4" v-for="mech in $store.state.mech" :key="mech.mechanicalPartID">
              <Card>
                <template #cardHeader>
                  <img :src="mech.imageURL" alt="Product Image" class="img-fluid" />
                </template>
                <template #cardBody>
                  <p>{{ mech.partName }}</p>
          ...
          <div class="row">
            <div class="col-md-3 mb-4" v-for="intExt in $store.state.intExt" :key="intExt.interiorExteriorID">
              <Card>
                <template #cardHeader>
                  <img :src="intExt.imageURL" alt="Product Image" class="img-fluid" />
                </template>
                <template #cardBody>
                  <p>{{ intExt.name }}</p>
