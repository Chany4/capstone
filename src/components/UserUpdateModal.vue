<template>
  <div>
      <button type="button" class="btn" data-bs-toggle="modal" :data-bs-target="'#adminEditUser'+user.userID"><i class="bi bi-pencil-square"></i></button>
                  ...
                  <div class="modal-body">
                      <form>
                          ...
                          <div class="modal-footer">
                              ...
                              <button type="submit" class="btn btn-outline-success" @click="updateUserFx()">Save Changes</button>
                          </div>
                      </form>
                  </div>
              </div>
